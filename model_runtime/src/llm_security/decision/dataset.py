...
from .mil.schema import CandidateDecisionContext


def write_case_jsonl(path: str | Path, cases: Iterable[CandidateDecisionContext]) -> None:
    """Persist nested project/candidate/bundle training examples."""
...
def read_case_jsonl(path: str | Path) -> list[CandidateDecisionContext]:
    ...
    for line_number, raw_line in enumerate(
        ...
        try:
            ...
            cases.append(CandidateDecisionContext.from_dict(value))
...
def write_feature_csv(
    ...
    *,
    ...
    """Optional flat diagnostic export; training uses ``write_case_jsonl``."""
...
def grouped_train_calibration_threshold_indices(
    ...
    *,
    ...
    """Named 70/15/15 split for model fit, calibration, and thresholding."""
